...
function EventLog({game_data, item_data, frame, frame_list, dimensions}){
    ...
    function DisplayEventsFilter(){
        ...
        return(<ul className='EventLogFilterList'>
                    <li className="EventLogIconFilter"><button><img src={gold_coin_image_link} className="EventLogIcon"></img></button></li>
                    <li className="EventLogIconFilter"><button><img src={lantern_image_link} className="EventLogIcon"></img></button></li>
                    <li className="EventLogIconFilter"><button><img src={sword_image_link} className="EventLogIcon"></img></button></li>
                    <li className="EventLogIconFilter"><button><img src={monster_image_link} className="EventLogIcon"></img></button></li>
                    <li className="EventLogIconFilter"><button><img src={castle_image_link} className="EventLogIcon"></img></button></li>
                </ul>
            )
