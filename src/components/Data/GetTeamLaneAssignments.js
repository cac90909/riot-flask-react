...
function GetTeamLaneAssignments({game_data, champ_data, item_data, ss_data, frame, frame_list}, team_1_ids){
    ...
    function TestCustomizer(test_being_conducted, lane, role, y_value, ss, items){
        ...
        if (test_being_conducted == "TOP"){
            ...
            if (y_value < 14000 && y_value > 12000){truth_value+=1}
            ...
            if (y_value < 12000 && y_value > 4000){ truth_value+=1}
            ...
            if (role == "SOLO"){truth_value+=1}
            if (y_value < 8000 && y_value > 6000){truth_value+=1}
            ...
            if (y_value < 4000 && y_value > 2000){truth_value+=1}
    ...
    function TestWrapper({game_data}, id, frame){
        ...
        var top_test_truth_value = TestCustomizer("TOP", lane, role, y, ss_names, items)
        var jungle_test_truth_value = TestCustomizer("JUNGLE", lane, role, y, ss_names, items)
        var middle_test_truth_value = TestCustomizer("MIDDLE", lane, role, y, ss_names, items)
        var bottom_adc_test_truth_value = TestCustomizer("BOTTOM_ADC", lane, role, y, ss_names, items)
        var bottom_support_test_truth_value = TestCustomizer("BOTTOM_SUPPORT", lane, role, y, ss_names, items)
